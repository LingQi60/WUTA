...
// void LineDetectorHandle::lidarClusterCallback(const jsk_recognition_msgs::BoundingBoxArray &bbox_array) {
//   line_detector_.setlidarCluster(bbox_array);
// }
void LineDetectorHandle::lidarClusterCallback(const jsk_recognition_msgs::BoundingBoxArray &boxs) {
  line_detector_.setlidarCluster(boxs);
}
